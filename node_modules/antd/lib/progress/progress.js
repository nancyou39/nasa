...
var Progress = /*#__PURE__*/function (_React$Component) {
  ...
  function Progress() {
    ...
    _this.renderProgress = function (_ref) {
      ...
      if (type === 'line') {
        progress = steps ? React.createElement(_Steps["default"], _extends({}, _this.props, {
          prefixCls: prefixCls,
          steps: steps
        }), progressInfo) : React.createElement(_Line["default"], _extends({}, _this.props, {
          prefixCls: prefixCls
        }), progressInfo);
      ...
      return React.createElement("div", _extends({}, (0, _omit["default"])(restProps, ['status', 'format', 'trailColor', 'successPercent', 'strokeWidth', 'width', 'gapDegree', 'gapPosition', 'strokeColor', 'strokeLinecap', 'percent', 'steps']), {
  ...
  _createClass(Progress, [{
    ...
    value: function renderProcessInfo(prefixCls, progressStatus) {
      ...
      if (format || progressStatus !== 'exception' && progressStatus !== 'success') {
        ...
        text = isLineType ? React.createElement(_CloseCircleFilled["default"], null) : React.createElement(_CloseOutlined["default"], null);
      } else if (progressStatus === 'success') {
        text = isLineType ? React.createElement(_CheckCircleFilled["default"], null) : React.createElement(_CheckOutlined["default"], null);
      }
