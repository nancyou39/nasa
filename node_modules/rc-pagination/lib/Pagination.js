...
var Pagination = /*#__PURE__*/function (_React$Component) {
  ...
  function Pagination(props) {
    ...
    _this.getItemIcon = function (icon) {
      ...
      var iconNode = icon || _react.default.createElement("a", {
  ...
  _createClass(Pagination, [{
    ...
    value: function render() {
      ...
      if (simple) {
        ...
        }, this.renderPrev(prevPage)), _react.default.createElement("li", {
      ...
      if (allPages <= 5 + pageBufferSize * 2) {
        ...
        if (!allPages) {
          pagerList.push(_react.default.createElement(_Pager.default, _extends({}, pagerProps, {
            key: "noPager",
            page: allPages,
      ...
      }, this.renderPrev(prevPage)), pagerList, _react.default.createElement("li", {
        title: showTitle ? locale.next_page : null,
        onClick: this.next,
      ...
      }, this.renderNext(nextPage)), _react.default.createElement(_Options.default, {
        disabled: disabled,
        locale: locale,
        rootPrefixCls: prefixCls,
